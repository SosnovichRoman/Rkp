    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".icon-menu")) {
                    ...
                    document.documentElement.classList.remove("sub-list-open");
                    document.documentElement.classList.remove("about-us-open");
                }
            }));
        }
        ...
        function rangeInit() {
            ...
            if (rangeItems.length) rangeItems.forEach((rangeItem => {
                const fromInput = rangeItem.querySelector("[data-range-from]");
                const toInput = rangeItem.querySelector("[data-range-to]");
                const item = rangeItem.querySelector("[data-range-item]");
                nouislider.create(item, {
                    start: [ Number(fromInput.value), Number(toInput.value) ],
                ...
                fromInput.addEventListener("change", setPriceValues);
                toInput.addEventListener("change", setPriceValues);
                function setPriceValues() {
                    let priceStartValue;
                    let priceEndValue;
                    if ("" != fromInput.value) priceStartValue = fromInput.value;
                    if ("" != toInput.value) priceEndValue = toInput.value;
                    item.noUiSlider.set([ priceStartValue, priceEndValue ]);
                }
                item.noUiSlider.on("update", setInputs);
                function setInputs() {
                    fromInput.value = item.noUiSlider.get(true)[0];
                    toInput.value = item.noUiSlider.get(true)[1];
                }
            }));
        }
        rangeInit();
        ...
        function initSliders() {
            if (document.querySelector(".equipment-supply-suppliers__slider")) new core(".equipment-supply-suppliers__slider", {
            ...
            if (document.querySelector(".about-company-offer__slider")) new core(".about-company-offer__slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
...
***************************************************************************** */
        ...
        da.init();
        const catalogButton = document.querySelector(".menu-catalog__catalog-button");
        if (catalogButton) catalogButton.addEventListener("click", (function(e) {
            if (window.matchMedia("max-width: 991.98px")) document.documentElement.classList.add("sub-list-open");
        }));
        const aboutUsMenu = document.querySelector(".about-us-menu");
        if (aboutUsMenu) aboutUsMenu.addEventListener("click", (function(e) {
            if (window.matchMedia("max-width: 991.98px")) document.documentElement.classList.add("about-us-open");
        }));
        window["FLS"] = true;
        isWebp();
        menuInit();
